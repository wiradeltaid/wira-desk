...
| 4 | `config.toml [layout]` | `_platform` | Persisted user configuration for layout | `stack_shortcut_enabled`, `stack_width_percent`, `stack_shortcut`, `move_next_monitor_shortcut`, `move_next_monitor_shortcut_enabled` | active |
