...
1. Application frameless shell (`no-frame: true`), navigation tabs (General, Shortcuts, Mouse, VM & Exceptions, About — `Layout` retired by `DEC-014`, `Mouse` added by `SPEC-8`), and adaptive light/dark theming (FR-19, AD-11a).
