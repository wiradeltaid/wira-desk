...
- [ ] **Decouple BackwardCycleSession reset from SwitcherArm and SwitcherDisarm**:
...
- [ ] **Preserve legitimate session reset boundaries**:
...
- [ ] **End-to-End Worker integration tests with SwitcherArm/Disarm lifecycle**:
